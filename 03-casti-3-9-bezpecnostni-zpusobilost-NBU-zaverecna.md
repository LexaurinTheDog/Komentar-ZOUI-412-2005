# Části třetí–devátá — Bezpečnostní způsobilost, bezpečnostní řízení, výkon státní správy, kontrola, přestupky a závěrečná ustanovení (§§ 80–161)

> **Téma kapitoly:** Druhá polovina zákona č. 412/2005 Sb. (dále „**ZOUI**" nebo „**zákon**") tvoří funkční celek, jenž navazuje na hmotněprávní úpravu ochrany utajovaných informací (Část druhá) a doplňuje ji o tři pilíře nezbytné k jejímu fungování v praxi: (i) **paralelní institut bezpečnostní způsobilosti fyzické osoby** pro tzv. citlivé činnosti, který se vědomě liší od osvědčení pro přístup k utajované informaci (Část třetí, §§ 80–88); (ii) **komplexní procesní úprava bezpečnostního řízení** prováděného Národním bezpečnostním úřadem (dále „**NBÚ**" nebo „**Úřad**") jako *lex specialis* vůči správnímu řádu (Část čtvrtá, §§ 88a–135); (iii) **institucionální a sankční rámec** — vymezení působnosti NBÚ jako ústředního správního úřadu, postavení zpravodajských služeb a Ministerstva vnitra, kontrolní mechanismy (Část pátá–sedmá, §§ 136–147), katalog přestupků s pokutami do 5 000 000 Kč (Část osmá, §§ 148–156) a přechodná a závěrečná ustanovení s účinností k 1. lednu 2006 (Část devátá, §§ 157–161). Klíčové instituty: **citlivá činnost** a **bezpečnostní způsobilost** jako samostatná veřejnoprávní kategorie odlišná od osvědčení k UI (§§ 80, 81, 84); **doklad o bezpečnostní způsobilosti** (§ 85) — veřejná listina s desetiletou platností; **bezpečnostní řízení** vedené v neveřejném režimu (§ 89) s vnitřně diferencovanou úpravou důkazní (§§ 104–106) a opravného prostředku formou rozkladu (§§ 125–134); **postavení NBÚ** jako ústředního správního úřadu se sídlem v Praze, jehož ředitele jmenuje vláda po projednání ve výboru PS (§ 136); **rozdělení působnosti** mezi NBÚ a Národní úřad pro kybernetickou a informační bezpečnost (dále „**NÚKIB**") v § 137 a 137a; **postavení zpravodajských služeb** jako *quasi*-správních orgánů s pravomocí Úřadu při bezpečnostním řízení vlastních příslušníků (§ 140) a obdobné postavení Ministerstva vnitra ve vztahu k vybraným policistům (§ 141); **parlamentní kontrola NBÚ** zvláštním kontrolním orgánem PS (§§ 145–147); **široký katalog přestupků** s pokutami v rozmezí 30 000 Kč až 5 000 000 Kč včetně trestnosti pokusu (§§ 148–155b, § 156); přechodný režim navazující na dosavadní úpravu podle zákona č. 148/1998 Sb. (§ 157); **účinnost ode dne 1. ledna 2006** (§ 161). Komentář k jednotlivým paragrafům uvádí znění zákona doslovně a klade důraz na vztahy k zákonu č. 153/1994 Sb., o zpravodajských službách, zákonu č. 289/2005 Sb., o Vojenském zpravodajství, zákonu č. 273/2008 Sb., o Policii ČR, ke správnímu řádu (zákon č. 500/2004 Sb.), soudnímu řádu správnímu, zákonu o přestupcích (č. 250/2016 Sb.) a k mezinárodním závazkům České republiky vyplývajícím z členství v NATO a Evropské unii.

---

## ČÁST TŘETÍ — Bezpečnostní způsobilost (§§ 80–88)

> **Pojetí kapitoly:** Část třetí zavádí **druhý**, na **osvědčení pro přístup k utajované informaci nezávislý**, institut prověřování fyzické osoby — **bezpečnostní způsobilost k výkonu citlivé činnosti**. Smyslem je vytvořit zákonný mechanismus pro funkce a činnosti, jejichž zneužitím by mohlo dojít k ohrožení zájmu České republiky, aniž by jejich výkon nutně vyžadoval přístup k utajované informaci. Typickými adresáty jsou pracovníci civilního letectví v citlivých provozních funkcích (zákon č. 49/1997 Sb.), členové Hradní stráže (zákon č. 219/1999 Sb.), pracovníci v oblasti nakládání s vojenským materiálem (zákon č. 38/1994 Sb.), pracovníci nakládající s jadernými materiály (atomový zákon č. 263/2016 Sb.) a další osoby uvedené v zákonech, jež na § 80 odst. 1 odkazují prostřednictvím poznámky pod čarou č. 32. Doklad o bezpečnostní způsobilosti se tak stává **lehčí formou** prověření, která sleduje **úžeji vymezený cíl** (osobní spolehlivost a integrita ve vztahu k výkonu konkrétní citlivé činnosti), aniž by zahrnovala plný rozsah šetření o styku s utajovanými informacemi.
...
1. **Formální znak** — činnost musí být označena jako citlivá buď přímo tímto zákonem (§ 88 — výkon citlivé činnosti pro potřeby zpravodajských služeb), anebo zvláštním právním předpisem. Poznámka pod čarou 32 demonstrativně odkazuje na zákon č. 38/1994 Sb., o zahraničním obchodu s vojenským materiálem, a na atomový zákon (č. 263/2016 Sb.); k tomu přistupují další zákony (např. § 55b odst. 3 zákona č. 49/1997 Sb., o civilním letectví, zákony o ochraně svědka — č. 137/2001 Sb., zákon o Hradní stráži). Nařízení vlády č. 31/2005 Sb. (civilní letectví) a obdobné prováděcí předpisy jsou nyní zrušeny § 160 a byly nahrazeny nařízeními navazujícími na současný režim.
2. **Materiální znak** — činnost se kvalifikuje jako citlivá jen tehdy, kdy *jejím zneužitím by mohlo dojít k ohrožení zájmu České republiky*. Zákonodárce zde užívá hypotézy v podmiňovacím způsobu („mohlo by"); nevyžaduje se tedy reálné ohrožení, postačí potenciální nebezpečí kvalifikované abstraktně. Tato formulace v sobě obsahuje **zásadu proporcionality** vůči § 1 — totiž že zákon má chránit zájem České republiky, jak je legálně definován v § 3 zákona.

Důležitý praktický rozdíl oproti pojmu „přístup k utajované informaci" spočívá v tom, že citlivá činnost **nepředpokládá nutně nakládání s utajovanou informací**. Citlivost je vlastností činnosti samotné (např. řízení kontroly cestujících na letišti, přístup k jaderným materiálům), nikoliv jejího nosiče. Citlivá činnost a přístup k UI tak mohou existovat současně, ale ani jeden ze vztahů není nutnou podmínkou druhého.

#### Tři alternativní průkazy způsobilosti (odst. 2)

Odst. 2 vymezuje **tři alternativní kvalifikace**, na základě nichž může být citlivá činnost vykonávána:

| Průkaz | Pramen | Charakter |
|---|---|---|
| **Doklad o bezpečnostní způsobilosti** | § 85 ZOUI | Veřejná listina vydaná NBÚ; specifická pro citlivou činnost |
| **Osvědčení fyzické osoby** (pro UI) | § 54 ZOUI | Veřejná listina vydaná NBÚ pro přístup k UI; obsahově širší než doklad |
| **Bezpečnostní oprávnění úřadu cizí moci** | § 57 ZOUI (uznání) | Vydáno bezpečnostním úřadem členského státu NATO, EU nebo státu, se kterým má ČR uzavřenou mezinárodní smlouvu |

Funkční dominance **osvědčení nad dokladem** je promyšlená: pokud osoba již prošla širším bezpečnostním řízením pro přístup k UI, není třeba duplikovat lehčí proceduru pro citlivou činnost. Naopak držitel pouze dokladu nemůže bez dalšího nakládat s utajovanou informací nad rámec stupně utajení Vyhrazené (viz § 80a a § 6 odst. 1).

#### Legislativní zkratka „doklad" (odst. 3)

Odstavec 3 zavádí pro účely celého zákona legislativní zkratku **„doklad"** pro „doklad o bezpečnostní způsobilosti fyzické osoby". Pozor: tato zkratka má v ZOUI specifický význam a nelze ji zaměňovat s obecným pojmem dokladu jako důkazního prostředku (např. listinný důkaz dle § 79 a násl. zákona č. 500/2004 Sb., správního řádu). Veškerý další výskyt slova „doklad" v ZOUI (s výjimkou ojedinělých kontextuálních užití typu „cestovní doklad", „doklad totožnosti") odkazuje na tento specifický institut.
...
Toto ustanovení (vložené pozdější novelou v souvislosti s krizovou legislativou) řeší specifický **interim**: situaci, kdy doba platnosti dokladu uplyne (§ 85 odst. 3 písm. a)) a žadatel již požádal o nový doklad podle § 99 odst. 3, avšak v důsledku vyhlášeného krizového stavu (definovaný zákonem č. 240/2000 Sb., o krizovém řízení) nemůže Úřad řízení uzavřít v běžných lhůtách (viz § 117 odst. 8, který stanoví, že lhůty neběží po dobu vyhlášeného krizového stavu).

Účinky § 80a jsou **dvojí a kumulativní**:

1. **Pokračování ve výkonu citlivé činnosti** — držitel formálně neplatného dokladu může pokračovat v citlivé činnosti, k níž byl dosud oprávněn. To zabraňuje paralýze citlivých provozů (např. civilního letectví, jaderných zařízení) v době krize.
...
**a) Státní občanství (písm. a))** — širší okruh než u osvědčení fyzické osoby podle § 12 odst. 1 písm. a), kde se vyžaduje **toliko české státní občanství**. U dokladu zákonodárce **rozšířil okruh přípustných občanství na občany členských států EU a NATO**, neboť účelem citlivé činnosti nezbytně není (na rozdíl od UI) ochrana státního tajemství v užším smyslu. Toto rozšíření odráží zásadu volného pohybu osob v rámci unijního práva (čl. 45 SFEU) a smluvní závazky vůči spojencům v NATO.

**b) Plná svéprávnost (písm. b))** — odkazuje na soukromoprávní úpravu (zejm. § 30 a § 55 a násl. zákona č. 89/2012 Sb., občanského zákoníku). Omezená svéprávnost stanovená soudním rozhodnutím podle § 57 občanského zákoníku vylučuje vydání dokladu. Procesní způsobilost v bezpečnostním řízení viz § 92b.

**c) Věk 18 let (písm. c))** — věk plnoletosti je obvyklou hranicí pro veřejnoprávní oprávnění s vyššími nároky na osobní zodpovědnost. Ověřuje se občanským průkazem nebo cestovním dokladem (odst. 2) — tedy listinami, jež zaručují identifikaci totožnosti pomocí dvou alternativních pramenů.

**d) Bezúhonnost (písm. d))** — odkaz na § 13 ZOUI je zde přímý: rozhodující je nepřítomnost odsouzení za úmyslný trestný čin nebo za vyjmenované nedbalostní trestné činy a další tam stanovené okolnosti. Pro doklad se aplikuje totožný režim bezúhonnosti jako pro osvědčení.

**e) Spolehlivost (písm. e))** — institut spolehlivosti je specificky upraven v § 84 (viz tam) a představuje **klíčový rozdíl** oproti bezpečnostnímu prověřování pro přístup k UI: pro doklad se nezjišťuje plné spektrum bezpečnostních rizik podle § 14, ale toliko zúžený seznam **negativních okolností** (§ 84 odst. 2 a 3).

#### Ověřování věku (odst. 2)

Ověření výhradně formou občanského průkazu nebo cestovního dokladu poskytuje vysokou míru právní jistoty. Vyloučení jiných listin (např. rodný list, vysokoškolský diplom) je vědomé — tyto listiny zpravidla nejsou aktualizovány a jejich důkazní síla je omezenější.
...
Spolehlivost je definována **negativně** — žadatel je spolehlivý tehdy, kdy *nebyla zjištěna* negativní okolnost. Důkazní břemeno k existenci negativní okolnosti tíží Úřad (zásada vyšetřovací podle § 89 odst. 1). Pokud Úřad nezjistí žádnou negativní okolnost ze seznamů v odstavcích 2 a 3, podmínka spolehlivosti je splněna.

#### Absolutní (tvrdé) negativní okolnosti (odst. 2)

Odst. 2 obsahuje **uzavřený a tvrdý** katalog tří okolností, jejichž zjištění **bez dalšího** znamená nesplnění spolehlivosti:

**Písm. a) — činnost proti zájmu ČR.** Tato kategorie zahrnuje jakoukoliv aktivitu, která svou povahou směřuje proti zájmu České republiky, jak je legálně definován v § 3 zákona (mj. svrchovanost, územní celistvost, demokratický a právní stát, vnější a vnitřní bezpečnost, plnění mezinárodních závazků). Příkladmo: spolupráce se zahraniční rozvědkou cizí moci, podíl na sabotážních akcích, propagace zahraničních zájmů namířených proti ČR.

**Písm. b) — majetková disproporce.** Zjevný nepoměr mezi přiznanými příjmy a skutečnými majetkovými poměry zakládá presumpci neoficiálních příjmových zdrojů, jež představují potenciální páku pro vydírání nebo korupci. Toto kritérium je převzato z mezinárodní praxe (NATO, EU) prověrkového řízení a vychází z konceptu *financial reliability*.

**Písm. c) — opakovaná neposkytovaná součinnost.** Toto písmeno se aplikuje **výhradně v řízení o zrušení platnosti dokladu**, nikoli při prvotním vydání. Zákonodárce zde sankcionuje obstrukci ze strany držitele tím, že jeho nesoučinnost sama o sobě konstituuje negativní okolnost. Předpoklady aplikace: (i) opakované neposkytnutí součinnosti **nebo** neudělení souhlasu podle § 109 odst. 2; (ii) nemožnost rozhodnout bez této součinnosti.

#### Diskreční (měkké) negativní okolnosti (odst. 3)

Odst. 3 obsahuje další tři okolnosti, které **lze považovat** za negativní — zákonodárce zde dává Úřadu **diskreční prostor** k posouzení individuálního případu. Důležité je slovo „lze" (a contrario k „je" v odst. 2). Aplikace odst. 3 vždy vyžaduje hodnocení podle odst. 5 (proporcionalita, intenzita, doba, chování v rozhodném období).

**Písm. a) — důvěryhodnost a ovlivnitelnost.** Pojetí blízké anglosaskému konceptu *trustworthiness*. Pokrývá chování typu: závislost na alkoholu nebo drogách (i jiné než léčebně zjištěná — to spadá pod písm. c), patologické hráčství, mimořádné dluhy, neuspořádané osobní vztahy s rizikem vydírání, falešná identita.

**Písm. b) — rizikové styky.** Kontakt s osobami, které vyvíjely nebo vyvíjejí činnost proti zájmu ČR. Zákon nevylučuje kontakty nezbytné (rodinné, služební), ale klade na ně kvalifikační požadavek významnosti a kontextu. Praxe NBÚ klade důraz na **vědomost** a **intenzitu** kontaktu.

**Písm. c) — zdravotní a osobnostní charakteristiky.** Toto písmeno se týká situací, kdy zdravotní nebo psychická charakteristika může negativně ovlivnit výkon citlivé činnosti — typicky závažné duševní poruchy, zjištěná závislost. Zákonodárce vyžaduje, aby šlo o vlastnosti, které mohou negativně ovlivnit *výkon citlivé činnosti*, nikoli obecné zdravotní problémy. K hodnocení slouží zpravidla znalecký posudek (§ 106).

#### Rozhodné období (odst. 4) — diferencovaný režim

Klíčové je, že **rozhodné období** se liší podle druhu negativní okolnosti:

| Okolnost | Rozhodné období |
|---|---|
| Odst. 2 písm. a) — činnost proti zájmu ČR | Od 15 let věku |
| Odst. 2 písm. b) — majetková disproporce | Od 15 let věku |
| Odst. 2 písm. c) — nesoučinnost | Pouze v probíhajícím řízení o zrušení |
| Odst. 3 písm. a) — důvěryhodnost a ovlivnitelnost | 10 let nebo od 15 let věku (kratší z nich) |
| Odst. 3 písm. b) — rizikové styky | 10 let nebo od 15 let věku (kratší z nich) |
| Odst. 3 písm. c) — zdravotní/osobnostní charakteristiky | (Není zákonem stanoveno, posuzuje se ad hoc) |

Diferenciace odráží intenzitu sankce: absolutní negativní okolnosti se zjišťují **dlouhodobě**, zatímco diskreční „měkké" se zjišťují za omezenější čas. Limit „od 15 let věku" je analogií k trestněprávnímu věku trestní odpovědnosti.

#### Test proporcionality (odst. 5)

Odst. 5 zavádí **standardní test proporcionality** pro hodnocení okolností podle odst. 3 (nikoli pro odst. 2, kde je hodnocení mechanické). Úřad přihlíží ke čtyřem kritériím:

1. **Míra možného ovlivnění výkonu citlivé činnosti** — kauzální vztah mezi okolností a citlivostí činnosti;
2. **Doba výskytu okolnosti** — staré okolnosti váží méně než aktuální;
3. **Rozsah a charakter okolnosti** — kvantitativní a kvalitativní hodnocení;
4. **Chování v rozhodném období** — vývoj osobnosti, signály resocializace.
...
#### Doklad jako veřejná listina (odst. 1)

Doklad o bezpečnostní způsobilosti je legislativně klasifikován jako **veřejná listina** ve smyslu § 567 občanského zákoníku a § 134 zákona č. 99/1963 Sb. (občanský soudní řád). Účinky jsou: (i) **presumpce pravdivosti** (svědčí důkazem o tom, co je v něm uvedeno); (ii) **vystavení procesnímu režimu** pro veřejné listiny při dokazování; (iii) **trestněprávní ochrana** podle § 348 trestního zákoníku (padělání a pozměnění veřejné listiny). Platnost na **10 let** je delší než u osvědčení fyzické osoby pro stupně utajení Tajné (9 let) a Přísně tajné (7 let, viz § 56 odst. 2), což odráží jiný (úžeji vymezený) předmět prověrky.

#### Obsahové náležitosti (odst. 2)

Náležitosti dokladu jsou taxativně vymezené. Obsahuje pouze základní identifikační údaje, datum vydání a platnosti a úřední atesty (otisk razítka, podpis). Doklad **neuvádí druh nebo specifikaci citlivé činnosti**, k níž opravňuje — to odráží jeho povahu **obecného oprávnění** k jakékoli citlivé činnosti, kterou zákony označují za citlivou. Vzor stanoví prováděcí vyhláška (odst. 7) — aktuálně je třeba odkázat na vyhlášku NBÚ, která nahradila zrušenou vyhlášku č. 348/2002 Sb.

#### Sedm důvodů zániku platnosti (odst. 3)

Důvody zániku platnosti jsou alternativní a vyčerpávající (numerus clausus):

| Písm. | Důvod | Charakter |
|---|---|---|
| a) | Uplynutí 10 let | Ex lege |
| b) | Vykonatelnost rozhodnutí o zrušení | Konstitutivní akt |
| c) | Úmrtí / prohlášení za mrtvého | Ex lege |
| d) | Ohlášení odcizení nebo ztráty | Notifikační akt |
| e) | Ohlášení poškození | Notifikační akt |
| f) | Vrácení dokladu Úřadu | Jednostranný akt držitele |
| g) | Doručení osvědčení FO nebo nového dokladu | Náhrada lex specialis |

Důvod g) je důležitý pro systémovou koherenci: pokud držitel dokladu obdrží osvědčení fyzické osoby (širší instrument), původní doklad ztrácí účel a zaniká. Obdobně doručení nového dokladu nahrazuje původní.

#### „Náhradní doklad" v případě poškození nebo ztráty (odst. 4)

Odst. 4 vytváří zvláštní **zrychlený režim** pro případy zániku platnosti z důvodů ohlášení odcizení, ztráty nebo poškození (písm. d) a e)). Pokud držitel do **15 dnů požádá** o nový doklad:

1. Citlivá činnost **není přerušena** — držitel pokračuje ve výkonu, jako by byl stále držitelem platného dokladu;
2. Úřad vydá nový doklad do **5 dnů od doručení žádosti**;
3. Nový doklad nahrazuje původní.

Tato úprava je pragmatická — vyhýbá se zbytečné disrupci provozů citlivých činností v případě nedbalostních ztrát originálu. Pokud však držitel nepožádá ve 15denní lhůtě, odpovědná osoba musí postupovat podle odst. 6 a zajistit, aby osoba dále nevykonávala citlivou činnost.

#### Změna údajů (odst. 5)

V případě formálních změn (změna jména, příjmení, státního občanství) Úřad vydává bezodkladně nový doklad; výkon citlivé činnosti opět **není přerušen**. Tato pragmatická úprava chrání jak držitele, tak jeho zaměstnavatele před zbytečnou administrativní zátěží.

#### Povinnost odpovědné osoby ukončit výkon (odst. 6)

V případech zániku platnosti podle písm. a), b) nebo f) (uplynutí, zrušení, vrácení) zákon stanoví **objektivní povinnost odpovědné osoby** (definice v § 2 písm. e) — typicky statutární orgán či jiná pověřená osoba podle § 64) zajistit, aby fyzická osoba **nevykonávala citlivou činnost**. Tato povinnost je sankčně vynucována přestupkem podle § 153 odst. 1 nebo § 155a (u podnikatelů). V případech b) a f) Úřad navíc **písemně vyrozumí** odpovědnou osobu, čímž zaměstnavatel získává oficiální informaci pro ukončení činnosti.
...
#### Pět povinností adresátů (typologie subjektů)

§ 86 ukládá soubor povinností **třem kategoriím subjektů**:

1. **Právnická osoba** — typicky obchodní společnost, družstvo, ústav, spolek;
2. **Podnikající fyzická osoba** — živnostník, samostatně podnikající;
3. **Orgán státu** — vymezuje § 2 písm. a) ZOUI (mj. ministerstva, jiné ústřední správní úřady, územní samosprávné celky, orgány obcí v přenesené působnosti, soudy, státní zastupitelství).

#### Písm. a) — záruka kvalifikovaného výkonu

Subjekt **nesmí umožnit** výkon citlivé činnosti osobě bez příslušného oprávnění (doklad, osvědčení FO nebo uznané bezpečnostní oprávnění úřadu cizí moci). Tato povinnost koresponduje s definicí citlivé činnosti v § 80 odst. 2 a je sankčně vynucována přestupkem podle § 153 odst. 2 písm. d) (do 1 000 000 Kč) a § 155a (do 1 000 000 Kč). Důležité: oprávnění **musí být platné v době výkonu**, nikoli pouze v době nástupu do funkce.

#### Písm. b) — evidence vykonavatelů

Subjekt vede vlastní **evidenci** osob, jež u něj vykonávají citlivou činnost. Evidence je v podstatě interní kontrolní nástroj. Není zákonem stanoven formát evidence — postačuje, že umožní pohotové zjištění totožnosti vykonavatelů, doby výkonu a stavu jejich oprávnění. Evidence se podle § 24 GDPR (nařízení Evropského parlamentu a Rady (EU) 2016/679) řídí zásadami omezení účelu a minimalizace údajů.

#### Písm. c) a d) — oznamovací povinnosti

Subjekt musí **bez prodlení písemně oznámit** Úřadu jak okolnosti, které způsobily, že důvod k vydání dokladu **odpadl** před rozhodnutím (písm. c), tak jakékoli jiné skutečnosti, jež mohou ovlivnit vydání dokladu nebo rozhodnutí o zrušení jeho platnosti (písm. d). Rozdíl mezi písm. c) a d):

- **Písm. c)** — týká se okolností týkajících se *odpadnutí důvodu žádosti*, tedy situací, kdy se citlivá činnost již nebude vykonávat (např. ukončení projektu).
- **Písm. d)** — týká se okolností týkajících se *splnění podmínek*, tedy situací nasvědčujících tomu, že držitel přestal splňovat předpoklady (např. zjištění negativní okolnosti).

Společný procesní efekt oznámení podle písm. d): zahájení řízení o zrušení platnosti dokladu (§ 101 odst. 1).

#### Písm. e) — oznámení o zahájení/ukončení výkonu

Subjekt oznamuje Úřadu **datum zahájení nebo ukončení** výkonu citlivé činnosti. Tato evidence je pro Úřad důležitá v kontextu evidence držitelů (§ 138 odst. 1 písm. b) a pro plnění informačních povinností vůči zpravodajským službám (§ 138 odst. 3). Sankce za nesplnění viz § 153 odst. 1 (do 300 000 Kč).
...
#### Tři povinnosti držitele (odst. 1)

**a) Odevzdání neplatného dokladu (15 dnů).** Lhůta začíná běžet od skutečnosti zakládající zánik (rozhodnutí o zrušení dle písm. b), poškození dle písm. e), doručení nového dokladu nebo osvědčení dle písm. g)). Sankcí za nesplnění je přestupek podle § 152 odst. 1 písm. a) (do 50 000 Kč).

**b) Oznámení ztráty, odcizení nebo poškození.** Lhůta je „neprodleně" — v praxi se vyžaduje oznámení do několika dnů od zjištění skutečnosti. Účelem je zachování přehledu Úřadu o aktuálním stavu dokladů a předcházení zneužití (zejména padělání). Sankce viz § 152 odst. 1 písm. b).

**c) Oznámení změny údajů.** Změny zahrnují obsahové údaje dokladu (jméno, příjmení, státní občanství) i údaje uvedené v žádosti (např. adresa, rodinný stav). Sankce viz § 152 odst. 1 písm. c). Prováděcí předpis (vyhláška NBÚ) může omezit rozsah oznamovaných změn na ty, které jsou pro účely zákona významné.
...
#### Specifický režim zpravodajských služeb

§ 88 zavádí **paralelní zjednodušený režim** pro citlivé činnosti vykonávané pro zpravodajskou službu. Adresáty jsou osoby, jež nejsou příslušníky nebo zaměstnanci zpravodajské služby (na ně dopadá § 140 odst. 1 písm. a)), ale vykonávají úkony pro zpravodajskou službu **na základě dohody** v souvislosti s výkonem státní správy nebo z jiného důvodu (typicky externí spolupracovníci, agenti, informátoři).

#### Trojí specifika

1. **Ověřování provádí zpravodajská služba sama** (nikoli NBÚ).
2. **Nevede se bezpečnostní řízení** podle Části čtvrté.
3. **Nevydává se doklad** — splnění podmínek § 81 je prokázáno interně, bez formálního akttu vůči externímu světu.

#### Časové omezení

Výkon je omezen na **dobu nutnou k provedení činnosti**. Není zde stanovena maximální lhůta — to umožňuje flexibilní reakci na operativní potřeby zpravodajských služeb. Smyslem je předejít trvalému formalizovanému postavení agentů a informátorů, jež by mohlo ohrozit jejich utajenost.
...
> **Pojetí kapitoly:** Část čtvrtá tvoří **procesní jádro celého zákona** — komplexní samostatnou úpravu bezpečnostního řízení, jež je vůči správnímu řádu (zákon č. 500/2004 Sb.) v zásadě **autonomní**. Pouze ve velmi úzkých oblastech (§ 35 odst. 2, řízení podle Části druhé Hlavy IX a řízení o přestupcích podle Části osmé) se subsidiárně použije správní řád (viz § 159). Tato autonomie je dána zvláštními požadavky bezpečnostního řízení: neveřejnost, nakládání s utajovanými informacemi, ochrana zdrojů zpravodajských služeb, specifický opravný prostředek (rozklad k řediteli NBÚ), omezený soudní přezkum. Část čtvrtá je vnitřně rozdělena do **pěti hlav**: Hlava I — Obecná ustanovení (§§ 88a–92f, účastníci, zastoupení); Hlava II — Průběh řízení (§§ 93–124, zahájení, žádosti, dotazníky, dokazování, lhůty, doručování, rozhodnutí, bezpečnostní svazek); Hlava III — Rozklad a soudní přezkum (§§ 125–132); Hlava IV — Soudní přezkum a závěrečné ustanovení (§§ 133–134); Hlava V — Zmocňovací ustanovení (§ 135).

### Hlava I — Obecná ustanovení

### § 88a — Předmět úpravy bezpečnostního řízení
...
#### Předmětový rozsah řízení (čtyři typy)

§ 88a definuje předmětný rozsah Části čtvrté čtyřmi alternativními typy řízení:

1. **Řízení o žádosti fyzické osoby o vydání osvědčení FO** (§ 94) — k přístupu k UI stupně Důvěrné, Tajné nebo Přísně tajné;
2. **Řízení o žádosti podnikatele o vydání osvědčení podnikatele** (§ 96) — k přístupu k UI;
3. **Řízení o žádosti o vydání dokladu** (§ 99) — k výkonu citlivé činnosti;
4. **Řízení o zrušení platnosti** kterékoli z výše uvedených veřejných listin.
...
1. **Zásada materiální pravdy a procesní ekonomie (odst. 1)** — Úřad musí zjistit „úplný a přesný" stav věci, ale **pouze v rozsahu nezbytném pro rozhodnutí**. Toto omezení je významné: bezpečnostní řízení **nesmí** být fishing expedicí — Úřad nesmí vyhledávat informace nad rámec potřeby. Zásada procesní ekonomie zahrnuje povinnost minimalizovat náklady a předcházet průtahům.

2. **Zásada respektu k osobnostním právům (odst. 2)** — povinnost šetřit *osobní čest a důstojnost* všech dotčených osob. Tato zásada je projekcí čl. 10 Listiny základních práv a svobod. Důsledkem je zákaz nepřípustně invazivních metod prověřování a zákaz znevažujícího jednání úředních osob.

3. **Zásada nediskriminace zdravotně postižených (odst. 3)** — pozitivní povinnost Úřadu vytvářet podmínky umožňující zachování práv zdravotně postižených účastníků. Konkretizace viz § 92d odst. 2 písm. b) (opatrovník zvlášť těžce postiženému), § 89c (zvukový záznam pro nevidomé), § 89b odst. 2 (tlumočení do češtiny).

4. **Zásada neveřejnosti (odst. 4)** — **kategorický rozdíl** od správního řádu (§ 49 odst. 2 SŘ, který zakládá ústní jednání zpravidla veřejné). Bezpečnostní řízení je obligatorně neveřejné — souvisí s povahou utajovaných informací, ochranou soukromí účastníka a obavou ze zpřístupnění informací o operativních postupech NBÚ a zpravodajských služeb.
...
§ 90 reprodukuje obvyklou úpravu podjatosti úřední osoby (srov. § 14 SŘ), s několika specifiky:

- **Patnáctidenní subjektivní lhůta** (odst. 3) pro vznesení námitky — po jejím marném uplynutí se k pozdější námitce **nepřihlíží** (kategorický prekluzivní účinek).
- **Neuplatnitelnost vůči řediteli Úřadu** (odst. 7) — tato výjimka je problematická a vyvolává ústavněprávní pochybnosti. Ředitel ovšem rozhoduje primárně o rozkladu (§ 130), tedy v opravném stupni; tam fakticky uplatňuje vlastní úsudek a podjatost se přepokládá u členů rozkladové komise. Mnozí komentátoři ji považují za sporné privilegium.
- **Aplikace na znalce a tlumočníky** (odst. 8) — koresponduje s § 11 zákona č. 254/2019 Sb., o znalcích.

#### „Druhá strana" — vyloučení pro účast na jiném stupni
...
#### Úzká definice účastníka

§ 92 vymezuje **uzavřený a vyčerpávající** okruh účastníků — odlišně od § 27 SŘ, který připouští kategorii „dotčených osob". V bezpečnostním řízení **není místa pro vedlejší účastníky** nebo zúčastněné osoby; účastníkem je pouze:

1. **Fyzická osoba** žádající o osvědčení nebo doklad (a osoba prověřovaná pro orgán EU/mezinárodní organizaci);
2. **Podnikatel** žádající o osvědčení podnikatele;
...
#### Tři typy zastoupení (§ 92c)

Účastník může být zastoupen:

1. **Zákonný zástupce** — typicky rodič nezletilého (§ 858 OZ) nebo opatrovník (§ 471 OZ);
2. **Opatrovník** — určený Úřadem v případech podle § 92d odst. 2 (typicky zvlášť těžce postižený, duševně nemocný);
3. **Zmocněnec** — advokát nebo jiný zástupce na základě písemné plné moci.

#### Omezení zastoupení

- **Pouze jeden zmocněnec** v dané době (§ 92e odst. 1) — vyloučení tzv. paralelního zastoupení;
- **Vyloučení zastoupení u osobních úkonů** (§ 92e odst. 1 in fine) — tedy zejména u pohovoru (§ 105), kde účastník musí vypovídat osobně, a u dotazníku (§ 95 a 97);
- **Substituční plná moc** vyžaduje výslovné dovolení v plné moci (§ 92e odst. 3).

#### Procesní způsobilost a opatrovník
...
#### Čtyři způsoby zahájení

Bezpečnostní řízení je zahájeno:

1. **Doručením žádosti FO** (§ 94) **nebo** žádosti o doklad (§ 99) — bez správního poplatku;
2. **Doručením žádosti podnikatele** (§ 96) **a** zaplacením správního poplatku — kumulativně;
3. **Doručením žádosti orgánu EU nebo mezinárodní organizace** (např. NATO HQ) — specifický mezinárodní rozměr, kdy se prověřuje státní občan ČR pracující v zahraničí;
4. **Doručením oznámení o zahájení řízení o zrušení** držiteli — *ex officio* zahájení.

#### Mezinárodní rozměr (písm. c))

Tato úprava odráží spolupráci ČR v rámci NATO a EU. Žádost orgánu EU (např. Evropská obranná agentura, Eurojust) nebo mezinárodní organizace (NATO, OSN, OBSE) se týká **státního občana ČR** zaměstnaného v této organizaci — princip subsidiarity národní bezpečnostní prověrky. Spolupráce s úřady cizí moci viz § 138 odst. 1 písm. j) a § 137 písm. c).
...
Žádost obsahuje tři esenciální složky:

1. **Písemné zdůvodnění nutnosti přístupu** — žadatel musí prokázat, že přístup k UI je pro výkon jeho funkce **nezbytný** (zásada need-to-know);
2. **Souhlas s provedením řízení** — kvalifikovaný souhlas se zpracováním osobních údajů a šetřením, vyžaduje se i ve smyslu GDPR (čl. 6 a 9);
3. **Prohlášení o pravdivosti a úplnosti** — zdůrazněn potenciál sankce za nepravdivou výpověď (§ 113 odst. 1 písm. h)).

#### Šest typů příloh (odst. 2)

Klíčovými přílohami jsou: dotazník v elektronické podobě (e-formulář NBÚ), doplňující písemnosti, fotografie, doklady cizince (je-li relevantní), **prohlášení o zproštění mlčenlivosti správce daně podle § 52 odst. 2 daňového řádu** (nezbytné pro ověření daňových údajů — viz též § 96 odst. 2 písm. d) a § 99 odst. 2 písm. c)) a zdůvodnění přístupu k UI od zaměstnavatele.

#### Lhůty pro renewal (odst. 3)

Žádost o nové osvědčení musí být podána **před uplynutím platnosti** stávajícího osvědčení v dostatečném předstihu:

| Stupeň utajení | Předstih |
|---|---|
| Důvěrné | 3 měsíce |
| Tajné | 7 měsíců |
...
> **§ 95**
>
> *(1) Dotazník fyzické osoby obsahuje tyto položky: [doslovný výčet 19 písmen — a) jméno, b) narození, c) občanství, d) bydliště za 10 let, e) doklad totožnosti, f) zaměstnavatel, g) zahraniční pobyt, h) výkony rozhodnutí, i) vazby na cizí zpravodajské služby, j) kontakty s cizinci, k) drogy a alkohol, l) patologické hráčství, m) léčba závislostí, n) majetkové poměry, o) členství ve spolcích, p) doručovací adresa, q) údaje rodinných příslušníků, r) životopis, s) zdravotní péče s vlivem na utajování]*

**Výklad:**

#### Komplexní dotazník — 19 položek

Dotazník je **klíčovým podkladem** prověřování. Obsahuje nejen identifikační údaje (písm. a–f), ale především celou **bezpečnostně významnou anamnézu** žadatele za období zpravidla 10 let nebo od 15 let věku (podle příslušného kritéria § 14 ZOUI). Některé položky jsou mimořádně citlivé z hlediska ústavního práva na soukromí:

- **Písm. i)** — vazby na cizí zpravodajské služby (klíčové pro odhalení agentury cizí moci);
- **Písm. j)** — osobní kontakty s cizinci ze států mimo EU/NATO (zachycení potenciálních zdrojů vlivu);
- **Písm. k)–m)** — užívání návykových látek a léčba závislosti (těžká „red flag" v bezpečnostní praxi);
- **Písm. n)** — majetkové poměry (souvislost s § 14 odst. 3 písm. b) — bezpečnostně významná informace);
- **Písm. q)** — údaje manžela/manželky, partnera, osob v domácnosti starších 18 let.
...
> **§ 96, § 97, § 98**
>
> *(doslovné znění viz zdroj — žádost obsahuje zdůvodnění nutnosti přístupu, stupně utajení a formy výskytu UI; přílohy: dotazník podnikatele, bezpečnostní dokumentace, doklady k podmínkám § 16, prohlášení o zproštění mlčenlivosti správce daně; dotazník obsahuje 18 položek včetně údajů o akcionářích, finanční historii, smlouvách s přístupem k UI; bezpečnostní dokumentace specifikuje systém ochrany UI u podnikatele)*

**Výklad:**

Pro podnikatele platí **rozsáhlejší a komplexnější** dokumentační režim než pro fyzickou osobu. Klíčové prvky:

#### Dotazník podnikatele (§ 97) — 18 položek

Pokrývá zejména: identifikační údaje z obchodního rejstříku, **údaje o akcionářích s podílem ≥ 10 %** (kontrolní řetězec až po skutečného majitele), tichý společník, bankovní účty v zahraničí, nemovitosti s utajovaným provozem, **účetní závěrky za 5 let**, závazky z úvěrových smluv v prodlení, **smlouvy s přístupem k UI**, zahraniční obchodní partneři s objemem > 2 mil. Kč, insolvenční historie, plnění závazků vůči státu, údaje odpovědné osoby, trestní řízení, seznam funkcí s přístupem k UI.

#### Bezpečnostní dokumentace (§ 98)

Není „dokladem", nýbrž **interním řídícím dokumentem** podnikatele, který:
- specifikuje konkrétní UI, k nimž má podnikatel přístup;
- obsahuje **analýzu hrozeb** a ochranná opatření;
- popisuje způsoby zajištění ochrany.

Musí být průběžně aktualizována — neaktualizace je přestupkem podle § 154 odst. 1 písm. b) (do 1 000 000 Kč).

#### Lhůty pro renewal podnikatele (§ 96 odst. 3)

| Stupeň utajení | Předstih |
|---|---|
| Důvěrné | 7 měsíců |
| Tajné | 9 měsíců |
| Přísně tajné | 11 měsíců |
...
> **§ 99**
>
> *(doslovné znění viz zdroj — žádost obsahuje zdůvodnění výkonu citlivé činnosti, souhlas s řízením, prohlášení o pravdivosti; přílohy: dotazník, doplňující písemnosti, prohlášení o zproštění mlčenlivosti správce daně, doklady cizince, fotografie, zdůvodnění výkonu od odpovědné osoby)*
>
> **§ 100 — Dotazník**
>
...
Dotazník pro doklad obsahuje **zúžený výčet** položek dotazníku FO — vynechány jsou položky:

- **q)** — údaje rodinných příslušníků (manžel, partner, osoby v domácnosti);
- mezi p) a r) — neexistuje (číslování v § 95 zachované, formálně se vynechává „přeskočená" položka).

Důvodem je užší předmět prověření bezpečnostní způsobilosti — nevyšetřuje se okolí prověřovaného, ale pouze on sám. Tato úspora vyšetřovacích nákladů koresponduje s redukovaným režimem ověřování podle § 109.
...
#### Klíčový institut bezpečnostní reflexe

§ 101 je páteří **dynamického prověřování** — umožňuje Úřadu reagovat na změny v okolnostech držitele. Důvody zahájení řízení:

- Vznik **důvodné pochybnosti** o trvajícím splnění podmínek (např. trestní řízení vedené proti držiteli, oznámení odpovědné osoby podle § 67/§ 86/§ 138c, výsledek šetření zpravodajské služby).

Pokud Úřad **zjistí**, že podmínky nejsou splňovány, **musí** zrušit platnost (odst. 2 — *Úřad ji zruší*; absence diskrece).

#### Neexistence možnosti přerušení a zastavení (odst. 3)

Důležitá procesní odchylka: řízení o zrušení **nelze přerušit ani zastavit** s úzkou výjimkou:

- § 113 odst. 1 písm. i) — smrt nebo prohlášení za mrtvého;
- § 113 odst. 1 písm. j) — odpadl důvod nebo předmět řízení.
...
#### Souběh povinnosti součinnosti účastníka a součinné role Úřadu

§ 102 odráží **paternalistický prvek** — Úřad „pomůže" účastníku odstranit formální nedostatky (zásada vstřícnosti, srov. § 4 odst. 2 SŘ). 30denní lhůta je závazná; její nedodržení vede k zastavení řízení (§ 113 odst. 1 písm. c).

§ 103 zakotvuje **trojí povinnost součinnosti účastníka**:

1. Reagovat na výzvu Úřadu k upřesnění (14 / 30 dnů);
2. Poskytnout součinnost pro ověření údajů;
...
#### Standardní úprava svědka s bezpečnostní specifikou

Úprava svědectví je analogická § 55 SŘ a § 126 OSŘ, s následujícími specifiky:

1. **Vyloučení svědka pro porušení mlčenlivosti** o UI — chrání primárně utajované informace, nikoli osobní svobodu svědka;
2. **Právo odepřít výpověď** osoby blízké účastníka (odst. 1 in fine) — odpovídá § 100 odst. 1 trestního řádu;
3. **Vyloučení příslušníků policie a zpravodajských služeb** podílejících se na řízení (odst. 6) — chrání **operativní informace** těchto orgánů; informace plynou výhradně cestou zpráv o výsledcích šetření (§ 107–109).
...
1. **Obligatorní u stupně Přísně tajné** — Úřad nemůže rezignovat na pohovor u nejvyššího stupně utajení;
2. **Osobní povinnost vypovídat** (odst. 3) — zástupce **nesmí zasahovat** (i když je přítomen). Toto je podstatné omezení procesního zastoupení a odráží smysl pohovoru — *posouzení osobnosti* žadatele;
3. **Záznam na zvukový nebo obrazový nosič** (odst. 6) možný se souhlasem účastníka **nebo** na jeho žádost (kdy je obligatorní);
4. **Zákaz sdělování UI při pohovoru** (odst. 7) — chrání utajované informace před zpřístupněním účastníkovi;
5. **Náhrada pohovoru písemným vyjádřením** u dlouhodobě v zahraničí pobývajícího účastníka (odst. 8).
...
Standardní úprava znaleckého dokazování podle zákona č. 254/2019 Sb., o znalcích. Typické případy znaleckého posudku v bezpečnostním řízení:

- **Psychologický nebo psychiatrický posudek** ke zhodnocení charakteristik osobnosti, závislosti atd. (§ 14 odst. 4 písm. c) ZOUI, § 84 odst. 3 písm. c) ZOUI);
- **Ekonomicko-účetní posudek** pro hodnocení majetkových poměrů (§ 14 odst. 3 písm. b), § 84 odst. 2 písm. b));
...
| Stupeň | Úkony |
|---|---|
| **Důvěrné** | Vyžádání informací od orgánů státu, PO a podnikajících FO |
| **Tajné** | + Ověření identity účastníka + případně šetření zpravodajské služby/policie k blízkým osobám |
| **Přísně tajné** | + Šetření zpravodajské služby k prostředí účastníka |

#### Souhlas účastníka pro rozšířené šetření (odst. 4)

Pokud informace nepostačují, Úřad **vyžádá písemný souhlas** účastníka s šetřením vyššího stupně (Tajné nebo Přísně tajné). Nesouhlas vede k zastavení řízení (§ 113 odst. 1 písm. e)).

#### Specifika u podnikatele (§ 108) a dokladu (§ 109)

- **§ 108** — u podnikatele Úřad ověřuje zejména **ekonomickou stabilitu, bezpečnostní spolehlivost, vlastnické vztahy a schopnost zabezpečit UI**. Úřední osoby mají oprávnění **vstupovat do objektů podnikatele** (odst. 4) — významná invazivní pravomoc.
- **§ 109** — u dokladu (citlivá činnost) je rozsah šetření **redukovaný** — pouze základní informační dotaz; dále již lze využít úkonů § 107 jen se souhlasem účastníka.

#### Spolupráce s informačními zdroji (§ 111)
...
#### Šest důvodů přerušení (taxativní)

1. **Prejudiciální otázka** (písm. a)) — typicky trestní řízení proti účastníkovi;
2. **Výzva k odstranění nedostatků nebo doplnění údajů** (písm. b)) — souvisí s § 102 a 103;
3. **Výzva k určení odpovědné osoby** (písm. c)) — typicky u podnikatele;
4. **Nemožnost výslechu svědka** (písm. d));
5. **Žádost účastníka** ze závažných důvodů — maximálně 60 dnů, dvakrát (písm. e));
6. **Ustanovení znalce** (písm. f)).
...
Zákonodárce zakotvuje **uzavřený katalog** deseti důvodů zastavení řízení. Klasifikace:

| Skupina | Důvody | Charakteristika |
|---|---|---|
| **Dispozice účastníka** | a), f) | Zpětvzetí, neurčení odpovědné osoby |
| **Nesplnění formálních podmínek** | b), c) | Chybějící bezúhonnost, svéprávnost, věk |
| **Procesní nesoučinnost** | d), e), h) | Nedostavení se, nesouhlas, nepravdivost |
| **Objektivní překážky** | g), i), j) | Dlouhodobý pobyt v zahraničí, smrt, odpadl důvod |
...
#### Vyšší pořádkové pokuty pro institucionální subjekty

Diferenciace pořádkových pokut **(50 000 Kč × 500 000 Kč)** odráží **různou míru závažnosti** nesoučinnosti:

- **Fyzická osoba** — pokuta do 50 000 Kč, kumulativní strop 100 000 Kč;
...
#### Komplexní matrice lhůt

§ 117 zakotvuje **diferencovaný systém lhůt** pro provedení jednotlivých typů řízení a šetření:

**Lhůty pro provedení úkonu podle § 121 (vydání rozhodnutí):**

| Řízení | Důvěrné | Tajné | Přísně tajné |
|---|---|---|---|
| FO (osvědčení FO) | 2 měsíce | 6 měsíců | 9 měsíců |
| Podnikatel | 6 měsíců | 8 měsíců | 10 měsíců |
| Doklad | — | — | 75 dnů |

**Lhůty pro šetření zpravodajské služby/policie:**

| Typ šetření | Tajné | Přísně tajné |
|---|---|---|
| Osvědčení FO (§ 107) | 4 měsíce | 6 měsíců |
| Osvědčení podnikatele (§ 108) | 4 měsíce | 6 měsíců (a 3 měsíce pro Důvěrné) |

#### Specifické režimy lhůt

- **Neběh za krizového stavu** (odst. 8) — chráněno bezpečnostními zájmy ČR;
- **Neběh do zahraničí** (§ 120 odst. 5) — komplikace doručování;
- **Možnost prodloužení ředitelem Úřadu** (§ 118 odst. 3) — nejvýše dvakrát, jednorázově nesmí přesáhnout standardní lhůtu.
...
§ 119 odst. 6 zakotvuje **standardní institut prominutí zmeškání lhůty**:

- Lhůta pro žádost: **5 dnů** od pominutí příčiny;
...
Pět doručovacích cest:

1. **Vlastními úředními osobami** Úřadu;
2. **Datová schránka** (zákon č. 300/2008 Sb.);
3. **Poštovní licence** (zákon č. 29/2000 Sb.);
4. **Ministerstvo zahraničních věcí** pro doručování do zahraničí;
5. **Bezpečnostní ředitel** v případě příslušníků/zaměstnanců ozbrojených sil v zahraničí.

#### Fikce doručení

Nepřevzata zásilka po 10 dnech uložení se považuje za doručenou (odst. 3) — standardní fikce. Při doručování do zahraničí lhůty zákona **neběží** (odst. 5) — chrání práva účastníka.
...
#### Klíčový princip „silent grant"

§ 121 odst. 1 zakotvuje princip, že pokud **Úřad vyhoví** žádosti, **nevydává písemné rozhodnutí** — vydá pouze osvědčení nebo doklad. Tato pragmatická úprava redukuje administrativu, ale zároveň znamená, že **vyhovující rozhodnutí nelze v plné formě přezkoumat** (samotná veřejná listina jako rozhodnutí).

#### Specifika odůvodnění u UI (§ 122 odst. 3)

Klíčový kompromis mezi **právem na informaci** o důvodech rozhodnutí a **ochranou utajených podkladů**: pokud jsou podklady utajované, odůvodnění uvádí **pouze odkaz** na ně a jejich stupeň utajení. Úvahy Úřadu se uvedou jen v rozsahu, který není utajen.

Tato úprava byla opakovaně předmětem ústavněprávního přezkumu. Ústavní soud ji shledal **proporcionální** (Pl. ÚS 41/02), s podmínkou, že soud má v rámci přezkumu plný přístup k podkladům.

#### Náležitosti rozhodnutí (§ 122 odst. 2 a 5)

Standardně: výrok, odůvodnění, poučení, označení Úřadu, datum, razítko, podpis. Drobnou specifikou je požadavek, aby **vykonatelnost** rozhodnutí byla **oznámena** odpovědné osobě účastníka (odst. 1) — zajišťuje rychlou reakci u zaměstnavatele.
...
#### Spisová evidence sui generis

Bezpečnostní svazek je **specifickou formou správního spisu**, jež se v několika klíčových aspektech odchyluje od běžné úpravy spisové dokumentace:

1. **Vnitřní členění** na utajovanou a neutajovanou část — zachycuje povahu dokumentace;
2. **11letá lhůta pro vyřazení** od posledního pravomocného rozhodnutí — delší než standardních 5 let podle archivního zákona;
3. **Vyloučení z režimu InfZ** (zákon č. 106/1999 Sb.) — bezpečnostní svazek **nepodléhá** režimu volného přístupu k informacím;
4. **Trvalá mlčenlivost zaměstnanců NBÚ** — i po skončení pracovního poměru;
5. **Zproštění mlčenlivosti** ředitelem Úřadu pro orgány činné v trestním řízení (odst. 5) — jediná zákonná výjimka.
...
### § 125–§ 127 — Základní úprava rozkladu
...
#### Rozklad jako jediný řádný opravný prostředek

Bezpečnostní řízení **nezná odvolání** v běžném smyslu — jediným opravným prostředkem je **rozklad**, o němž rozhoduje ředitel Úřadu (zpravidla na základě návrhu rozkladové komise — § 130). Tato úprava je formálně analogická § 152 SŘ (rozklad proti rozhodnutí ústředního správního orgánu), s následujícími specifiky:

1. **Patnáctidenní lhůta** od doručení (odst. 1) — kratší než obvyklých 15 dnů SŘ, identická;
2. **Tříměsíční lhůta** při chybném poučení (odst. 2);
3. **Možnost prominutí zmeškání** ze závažných důvodů (odst. 3) — 15 dnů od pominutí překážky;
4. **Vyloučení odkladného účinku** u rozkladu proti zrušení platnosti (odst. 4) — toto je významná specifika: ten, komu byla zrušena platnost, **bezprostředně ztrácí oprávnění** k UI nebo citlivé činnosti, i když rozklad podá. Tato úprava je opodstatněna nutností okamžité ochrany zájmů státu, ale je předmětem oprávněné kritiky pro tvrdý dopad.

#### Náležitosti rozkladu (§ 127)
...
§§ 128–129 zavádějí **dva typy zkráceného postupu**, kdy o rozkladu nerozhoduje ředitel Úřadu, ale Úřad sám:

1. **Zamítnutí pro nepřípustnost nebo opožděnost** (§ 128) — formální stránka, není třeba meritorního přezkumu;
...
1. **Minimálně 5 členů**, vždy lichý počet;
2. **Více než polovina právníků** (právnické VŠ vzdělání magisterské) — odráží zákonný charakter rozkladového řízení;
3. **Většina ze státních orgánů mimo NBÚ** (odst. 3) — zaručuje **vnější perspektivu** v přezkumu, odděluje rozkladovou komisi od běžného aparátu Úřadu;
4. **Členové musí mít osvědčení FO** a být občany ČR — zaručuje přístup k UI a národní loajalitu;
5. **Funkční období 5 let**, předseda rotuje po 1 roce.

Rozkladová komise **nerozhoduje** — jen **navrhuje** rozhodnutí řediteli. Ředitel není návrhem vázán, ale fakticky obvykle návrh přebírá. Mlčení o návrhu v zákoně neznamená jeho právní bezvýznamnost — v praxi je návrh klíčovým podkladem rozhodnutí.
...
#### Tři možná rozhodnutí ředitele

Ředitel Úřadu může v rozkladovém řízení:

1. **Zastavit řízení o rozkladu** (odst. 1–3) — viz důvody zastavení tam vyjmenované;
2. **Zrušit napadené rozhodnutí**:
   - V plném rozsahu (odst. 5) — typicky u nesprávně rozhodnutého zrušení platnosti;
   - S vrácením k novému projednání (odst. 6) — kasační účinek;
3. **Zamítnout rozklad a potvrdit rozhodnutí** (odst. 7).

#### Závaznost právního názoru (odst. 8)

V případě kasačního rozhodnutí (odst. 6) **právní názor ředitele** je **závazný** pro Úřad při novém projednání. Toto je standardní mechanismus zaručující efektivitu opravného prostředku.

#### Tříměsíční lhůta (odst. 9)
...
§ 133 je **klíčovým ustanovením** pro vztah bezpečnostního řízení a soudního přezkumu. Žaloba ve správním soudnictví (zákon č. 150/2002 Sb., soudní řád správní) je přípustná **jen proti** rozhodnutím ředitele Úřadu uvedeným v odst. 1 — tedy zejména:

- Rozhodnutí o zastavení řízení o rozkladu pro neodstranění nedostatků (§ 131 odst. 2 písm. b));
- Obdobně u řízení o zrušení platnosti (§ 131 odst. 3 písm. b));
- Rozhodnutí o zrušení napadeného rozhodnutí (§ 131 odst. 5);
- Rozhodnutí o zrušení s vrácením (odst. 6);
- Rozhodnutí o zamítnutí rozkladu (odst. 7).

#### Modifikace standardních pravidel dokazování (odst. 2 a 3)

Při soudním přezkumu **soud má přístup k utajeným podkladům**, ale účastník nikoli — jde o **klíčový kompromis** mezi právem na spravedlivý proces a ochranou utajovaných informací. Mechanismus:

1. Úřad označí okolnosti, o nichž tvrdí, že je nelze zpřístupnit;
2. **Předseda senátu** rozhodne o oddělení částí spisu — pokud činnost zpravodajských služeb nebo policie může být ohrožena;
3. **Účastník, jeho zástupce a OZÚ** do oddělených částí **nenahlíží**.
...
### § 135 — Zmocnění k prováděcím předpisům

> **§ 135**
>
> *Prováděcí právní předpis stanoví [a) vzor poučení podle § 58 odst. 5, b) vzory a způsob podání žádostí, c) rozsah a formu písemností, d) rozsah údajů dotazníku podnikatele, e) vzor dotazníku FO a rozsah údajů, f) rozsah a formu písemností u podnikatele a vzor dotazníku podnikatele, g) rozsah a formu písemností a vzor dotazníku u dokladu, h) rozsah písemného zdůvodnění, i) omezení rozsahu hlášení změn údajů, j) vzor zproštění mlčenlivosti].*
...
> **Pojetí kapitoly:** Část pátá zakotvuje **institucionální architekturu** výkonu státní správy v oblasti ochrany utajovaných informací a bezpečnostní způsobilosti. Definuje **Národní bezpečnostní úřad** (NBÚ) jako **ústřední správní úřad** v této oblasti, postavení jeho ředitele, kompetenční katalog Úřadu a Národního úřadu pro kybernetickou a informační bezpečnost (NÚKIB) — jenž v r. 2017 přebral od NBÚ kybernetickou agendu, dále specifické postavení **zpravodajských služeb** a **Ministerstva vnitra** jako *quasi*-správních orgánů s pravomocí Úřadu při bezpečnostním řízení vlastních osob. Centrálním prvkem je rozlišení tří „okruhů" výkonu prověřování: (i) civilní okruh — NBÚ; (ii) zpravodajský okruh — BIS, ÚZSI, Vojenské zpravodajství (§ 140); (iii) policejní okruh — Ministerstvo vnitra pro vybrané policisty (§ 141).

### § 136 — Postavení NBÚ a jeho ředitele
...
#### NBÚ jako ústřední správní úřad (odst. 1)

§ 136 odst. 1 deklaruje **NBÚ jako ústřední správní úřad** v oblasti ochrany utajovaných informací a bezpečnostní způsobilosti. Pojetí „ústřední správní úřad" navazuje na zákon č. 2/1969 Sb., o zřízení ministerstev a jiných ústředních orgánů státní správy ČR (kompetenční zákon), v jehož § 2 odst. 1 bod 4 je NBÚ uveden jako ústřední orgán státní správy ČR.

NBÚ tedy patří mezi **ústřední orgány bez postavení ministerstva** — kategorie, do níž spadají též ČSÚ, ČÚZK, ČBÚ, RVR aj. NBÚ má následující institucionální charakteristiky:

- **Sídlo:** Praha (v praxi se sídlí v ulici Na Popelce);
- **Územní rozsah:** celostátní;
- **Druh státní správy:** **horizontální (specializovaná)** — pokrývá konkrétní věcný úsek napříč státem.

Klauzule „pokud tento zákon nestanoví jinak" odkazuje na rozdělení působnosti mezi NBÚ, NÚKIB (§ 137a), zpravodajské služby (§ 140) a Ministerstvo vnitra (§ 141).

#### Ředitel NBÚ — jmenování a odpovědnost (odst. 2 a 3)

Procedura jmenování ředitele NBÚ je **dvoufázová**:

1. **Projednání ve výboru PS příslušném ve věcech bezpečnosti** (typicky Výbor pro obranu a bezpečnost) — **politická konzultace**, nikoli souhlas; vláda návrh projedná, ale není projednáním vázána;
2. **Jmenování (a odvolání) vládou** — formální akt.

Tato úprava poskytuje **parlamentní vliv** na obsazování klíčové bezpečnostní funkce, aniž by ohrožovala vládní pravomoc rozhodovat o exekutivní funkci. Obdobnou úpravu nacházíme u ředitelů zpravodajských služeb (BIS, ÚZSI).

**Odpovědnost ředitele** je vůči **předsedovi vlády nebo pověřenému členovi vlády**. V praxi je NBÚ tradičně pověřen předseda vlády nebo jeho zástupce; v některých vládách bylo pověřeno ministerstvo vnitra nebo zvláštní ministr bez portfeje.

#### Personální a platový režim (odst. 4)
...
#### Komplexní katalog působnosti

§ 137 obsahuje **13 položek** věcné působnosti NBÚ. Strukturální klasifikace:

| Funkce | Položky | Charakteristika |
|---|---|---|
| **Rozhodovací** | a), i), j) | Vydávání osvědčení a dokladů, ukládání sankcí |
| **Kontrolní a metodická** | b) | Inspekce a metodika |
| **Mezinárodní** | c), e), f) | Spolupráce v rámci NATO a EU |
| **Registrační** | d) | Ústřední registr UI |
| **Technicko-certifikační** | g) | Technické prostředky (NB: informační systémy přešly na NÚKIB) |
| **Normotvorná** | h), k) | Bezpečnostní standardy a Věstník NBÚ |
| **Informační** | l) | Veřejně přístupný seznam veřejných listin |
| **Výzkum** | m) | R&D v oblasti ochrany UI |

#### Mezinárodní rozměr (písm. c))

Toto písmeno zakotvuje úkoly NBÚ v rámci:

1. **Členství v EU** — spolupráce v rámci Rady EU (zejm. politika kybernetické bezpečnosti, EEAS, EDA, COREPER) a institucí EU vyžadujících utajení;
2. **Členství v NATO** — spolupráce v rámci NATO Security Committee, NATO Office of Security; uznávání NATO Cosmic Top Secret, NATO Secret, NATO Confidential, NATO Restricted;
3. **Mezinárodní smlouvy** — bilaterální dohody o vzájemné ochraně utajovaných informací (s USA, Velkou Británií, Německem, Izraelem a desítkami dalších států);
4. **Provádění prověrkových úkonů pro cizí úřady** — vůči osobám prověřovaným cizím bezpečnostním orgánem.

NBÚ je tak **národním bezpečnostním úřadem** (NSA — National Security Authority) ve smyslu mezinárodní bezpečnostní terminologie.

#### Ústřední registr UI (písm. d))

NBÚ vede **ústřední registr** utajovaných informací — primárně mezinárodních. **Schvaluje zřízení registrů** v orgánech státu, u právnických osob (§ 60b) a u podnikatelů. Registr je organizační jednotka pověřená příjmem, evidováním a distribucí utajovaných informací (zejm. ze zahraničí).
...
#### Vznik NÚKIB a rozdělení působnosti

**NÚKIB** byl zřízen zákonem č. 205/2017 Sb. (novela zákona o kybernetické bezpečnosti) s účinností od 1. srpna 2017 jako **ústřední správní úřad** pro kybernetickou a informační bezpečnost. Vznikl **vyčleněním** odpovídající agendy z NBÚ. Tímto rozdělením se vytvořila funkční specializace:

| Oblast | NBÚ (§ 137) | NÚKIB (§ 137a) |
|---|---|---|
| **Bezpečnostní řízení a UI** | Ano | Ne |
| **Bezpečnostní způsobilost (citlivá činnost)** | Ano | Ne |
| **Zkoušky zvláštní odborné způsobilosti** | Ne | Ano (písm. a) |
| **Certifikace informačních systémů** | Ne | Ano (písm. e) |
| **Certifikace kryptografických prostředků** | Ne | Ano (písm. e) |
| **Kryptografická ochrana** | Ne | Ano (písm. f, g) |
| **Kompromitující vyzařování (TEMPEST)** | Ne | Ano (písm. h) |
| **Certifikace technických prostředků (jiných)** | Ano (§ 137 písm. g) | Ne |
| **Mezinárodní spolupráce v oblasti utajení** | Ano (písm. c) | Ano ve vybraných oblastech (písm. b) |
| **Bezpečnostní standardy** | Ano (písm. h) | Ano (písm. j) |
| **Sankce za přestupky** | Vybrané (§ 156) | Vybrané (§ 156) |

#### Národní střediska (písm. d))

NÚKIB zajišťuje činnost **čtyř národních středisek**:

1. **Národní středisko komunikační bezpečnosti** (NSCB) — bezpečnost komunikačních systémů;
2. **Národní středisko pro distribuci kryptografického materiálu** (NSDKM) — logistika kryptomateriálu;
3. **Národní středisko pro měření kompromitujícího vyzařování** (NSMKV) — TEMPEST;
4. **Národní středisko pro bezpečnost informačních systémů** (NSBIS) — certifikace IS.

Tato střediska jsou pokračováním obdobných středisek dříve provozovaných NBÚ.
...
#### Komplex pravomocí NBÚ

§ 138 obsahuje **12 pravomocí** (písm. a–l), které dohromady tvoří **operační repertoár** NBÚ. Tyto pravomoci se dají rozdělit do několika skupin:

1. **Zpracování informací** — písm. a), b), i) — zpracování osobních údajů, vedení evidencí, ukládání;
2. **Získávání informací** — písm. c), d), e), f) — od orgánů státu, policie a zpravodajských služeb, z RT a evidence přestupků, z trestních a soudních spisů;
3. **Sdílení informací** — písm. g), j) — předávání orgánům a cizím úřadům;
4. **Smluvní spolupráce** — písm. h) — outsourcing certifikace;
5. **Specifické součinnosti** — písm. k), l) — s UOHS, se zpravodajskou službou.

#### Vyloučení nahlížení do svazku zpravodajské služby (odst. 2)

Zpravodajská služba **může odmítnout** nahlížení do svých spisů. Z nahlížení **je vyloučen bezpečnostní svazek vedený podle § 124** — princip vzájemné ochrany svazků.

#### Pravidelný informační tok (odst. 3)

NBÚ poskytuje **jednou měsíčně** seznamy:

- **Zpravodajským službám a Ministerstvu vnitra**: osvědčení FO, osvědčení podnikatelů, dokladů (platnost, zánik), osob s nevydaným osvědčením, osob s prohlášením podnikatele;
- **Policii, GIBS, GŘC a Vojenské policii**: seznam osvědčení a dokladů a prohlášení podnikatele.

Tato pravidelná synchronizace zaručuje **aktuálnost informací** ve všech relevantních složkách bezpečnostního systému státu.

#### Pravomoci NÚKIB (odst. 6)
...
§ 138c rozšiřuje **dohled nad držiteli** prověření na pět dalších bezpečnostních složek:

1. **Ministerstvo vnitra**;
2. **Policie ČR**;
3. **Generální inspekce bezpečnostních sborů** (GIBS, zákon č. 341/2011 Sb.);
4. **Generální ředitelství cel** (GŘC, zákon č. 17/2012 Sb.);
5. **Vojenská policie** (zákon č. 300/2013 Sb.).
...
#### Quasi-správní postavení zpravodajských služeb

§ 140 představuje **klíčovou strukturální specifiku**: zpravodajské služby mají **postavení Úřadu** (a odpovědná osoba zpravodajské služby postavení ředitele Úřadu) při rozhodování o žádosti fyzické osoby **vlastních příslušníků nebo zaměstnanců**. Důvodem této úpravy je:

1. **Ochrana operativních zájmů** — kdyby NBÚ prověřoval příslušníky zpravodajských služeb, hrozilo by zpřístupnění identity tajných agentů;
2. **Operativní efektivita** — zpravodajské služby mají vlastní vyšetřovací aparát a mohou prověřit příslušníka rychleji;
3. **Vnitřní disciplína** — vlastní prověřování je součástí personální politiky zpravodajských služeb.

Adresáty této pravomoci zpravodajských služeb jsou:

- **Příslušníci** (definováno zákonem č. 361/2003 Sb., o služebním poměru);
- **Zaměstnanci** (civilní v rámci pracovněprávního vztahu);
- **Uchazeči o přijetí** (do služebního nebo pracovněprávního vztahu);
- **Vojáci v aktivní záloze** u Vojenského zpravodajství.

#### Příslušnost (odst. 2)

Příslušnost mezi BIS, ÚZSI a Vojenským zpravodajstvím se řídí § 5 zákona č. 153/1994 Sb. Pravidlo lze shrnout:

- **BIS** — vnitřní zpravodajská služba, civilní příslušníci;
- **ÚZSI** — zahraniční zpravodajská služba, civilní příslušníci;
- **Vojenské zpravodajství** — vojenští příslušníci, vojáci v aktivní záloze (zákon č. 289/2005 Sb.).

#### Oznamovací povinnost vůči NBÚ (odst. 3)

Zpravodajské služby oznamují **neprodleně NBÚ**, zjistí-li okolnosti nasvědčující ztrátě splnění podmínek, **neohrozí-li to zájem sledovaný zpravodajskou službou**. Tato klauzule poskytuje zpravodajským službám **diskreční oprávnění** zatajit informaci, pokud by ohrozila jejich operativu — racionální vyvážení transparentnosti a operativní bezpečnosti.

#### Široký katalog operativních oprávnění (odst. 4)

Zpravodajské služby jsou v rámci úkolů podle ZOUI oprávněny k **dvanácti specifickým činnostem** (písm. a–l), mj.:

- **Používání zpravodajských prostředků** (písm. a) — odkaz na zvláštní zákony;
- **Využívání evidencí** vlastních i poskytnutých NBÚ (písm. b);
- **Údaje z evidencí československých bezpečnostních a vojenských orgánů** (písm. c) — odkaz na archivní materiály komunistické éry;
- **Opatření k evidenční ochraně osobních údajů FO** (písm. i) — zachycuje princip *cover identity*;
- **Doplňující informace nad rámec dotazníku** (písm. k) — operativní flexibilita.

#### Zvláštní postupy v krizových situacích (odst. 10)
...
#### Třetí samostatný kanál: MV pro vybrané policisty

§ 141 zavádí **třetí kanál** bezpečnostního řízení — Ministerstvo vnitra pro **vybrané příslušníky policie**. Klíčová slova: *vybraných v zájmu plnění závažných úkolů policie ministrem vnitra*. Jde typicky o:

- Příslušníky **specializovaných policejních útvarů** (NCOZ, ÚOOZ, ÚHCP);
- Příslušníky **operativní agendy** s rizikem prozrazení identity;
- Příslušníky **organizovaného zločinu**, **terorismu** apod.

Mechanismus výběru je analogický s § 88 (citlivá činnost pro zpravodajskou službu) — chrání identitu policistů s operativními úkoly.

#### Postavení MV (odst. 2)

MV má **postavení Úřadu**, ministr vnitra **postavení ředitele Úřadu** v daných řízeních. Procedurálně se postupuje stejně jako u NBÚ.

#### Specifická povinnost MV (odst. 3)

MV provádí **na žádost NBÚ** opatření k **evidenční ochraně osobních údajů** držitele osvědčení FO a jeho blízkých osob (manžel, partner, dítě, rodič, osoba v domácnosti) a údajů o vozidlech. Toto je institut **cover protection** — utajení skutečné identity v evidencích (typicky občanský registr, registr vozidel, daňová evidence) za účelem ochrany před cizí mocí.

#### Pravomoci MV (odst. 4) a součinnost policie (odst. 7)
...
#### Procedurální úprava ztrát a nálezů

§ 142 řeší **specifický procesní problém**: co se má stát s utajovanou informací nebo osvědčením/dokladem, který byl nalezen třetí osobou a odevzdán policii nebo zastupitelskému úřadu ČR? Mechanismus:

1. **Sepsání záznamu o odevzdání** — totožnost odevzdávajícího, okolnosti nálezu;
2. **Předání NBÚ** — centralizace agendy;
3. **Doručení původci nebo držiteli** — vrácení do oficiálního oběhu.
...
> **Pojetí kapitoly:** Část šestá zakotvuje **kontrolní pravomoci NBÚ** vůči adresátům povinností podle ZOUI — orgánům státu, právnickým osobám podle § 60b, podnikatelům a fyzickým osobám. Důležitá je zde součinnost s NÚKIB v oblasti kybernetické bezpečnosti.

### § 143 — Kontrolní pravomoci NBÚ
...
NBÚ kontroluje **dodržování všech právních předpisů** v oblasti ochrany UI a bezpečnostní způsobilosti — tedy **nejen** ZOUI, ale i prováděcích vyhlášek, nařízení vlády a mezinárodních pravidel.

**Kontrolovanou osobou** je:

1. **Orgán státu** (definice v § 2 písm. a) ZOUI);
2. **Právnická osoba podle § 60b** — typicky státní podnik, družstvo atd. nakládající s UI;
3. **Podnikatel** (s osvědčením podnikatele);
4. **Fyzická osoba** — držitel osvědčení FO nebo dokladu.

Procesně se postupuje podle **zákona č. 255/2012 Sb., o kontrole (kontrolní řád)**, není-li v ZOUI stanoveno jinak.

#### Přístup k UI při kontrole (odst. 2)

Kontrolní pracovníci mají **automatický přístup k UI** v rozsahu prováděné kontroly **na základě svého osvědčení FO**. Tato úprava odráží zásadu, že kontrola se nemůže omezit jen na neutajované části provozů.

#### Účast cizí moci (odst. 3)

Úřad cizí moci je oprávněn **účastnit se kontroly** UI poskytnutých ČR cizí mocí, pokud to vyplývá ze závazků EU nebo mezinárodní smlouvy. Typicky jde o **inspekce NATO Security Committee** nebo EU bezpečnostní orgány kontrolující řádné nakládání s utajovanou informací EU/NATO.

#### Vyloučení zpravodajských služeb a MV (odst. 4)

**Zásadní výjimka:** činnost zpravodajských služeb a MV (v případech podle § 141) **nepodléhá** kontrole NBÚ. Tato úprava je výrazem **dělby moci** mezi bezpečnostními složkami — kontrola zpravodajských služeb se provádí v jiných režimech (parlamentní kontrolní výbory pro BIS a Vojenské zpravodajství podle zákona č. 154/1994 Sb., § 12 a násl., resp. zákona č. 289/2005 Sb.).
...
#### Neodkladná opatření k ochraně UI

Kontrolní pracovníci jsou oprávněni **na místě** přijmout **neodkladná opatření**, mj.:

1. **Odejmutí UI** — fyzické převzetí utajované informace, jejíž ochrana je narušena;
2. **Zrušení nebo změna stupně utajení** — pokud aktuální klasifikace je nesprávná;
3. **Označení informace stupněm utajení** — pokud informace má být utajována, ale ještě není;
4. **Lhůtové uložení nápravy** — typický nástroj.

Tato pravomoc je obdobou kompetencí policejního orgánu nebo finanční správy při zajišťovacích opatřeních.

#### Náklady na opatření (odst. 2)

Náklady hradí **kontrolovaná osoba** — princip *polluter pays*. Toto je sankcionující nástroj — finanční pobídka k řádnému plnění povinností.
...
> **Pojetí kapitoly:** Část sedmá zakotvuje **parlamentní kontrolu NBÚ** — institut analogický kontrolním orgánům PS nad zpravodajskými službami (zákony č. 154/1994 Sb. a č. 289/2005 Sb.). Smyslem je zaručit demokratický dohled nad bezpečnostním aparátem státu.

### § 145 — Zvláštní kontrolní orgán PS
...
#### Strukturální zaštítění parlamentní kontroly

§ 145 zřizuje **zvláštní kontrolní orgán PS** s následujícími atributy:

1. **Členy jsou pouze poslanci PS** — politicko-demokratický charakter;
2. **Minimálně 7 členů**, vždy lichý počet;
3. **Zastoupení všech politických klubů** — koaliční i opoziční pluralism;
4. **Procesní úprava** se řídí jednacím řádem PS (zákon č. 90/1995 Sb.), nikoli kontrolním řádem (zákon č. 255/2012 Sb.) — kontrola má politický, nikoli administrativní charakter.

#### Pravomoci kontrolního orgánu (odst. 4 a 5)

Kontrolní orgán:

- **Vstupuje do objektů NBÚ** s doprovodem ředitele nebo jím pověřeného zaměstnance;
- **Dostává předkládané informace** od ředitele — zprávu o činnosti, zprávy o řízeních, návrh rozpočtu, podklady pro kontrolu rozpočtu, vnitřní předpisy.

#### Omezení (odst. 6) — princip dělby moci

Kontrolní orgán **nesmí**:

- Zasahovat do **personálních pravomocí** vedoucích pracovníků NBÚ;
- **Nahrazovat řídicí činnost** vedoucích pracovníků.
...
#### Vysvětlení a oznámení

Kontrolní orgán má **dvojí reakční nástroj**:

1. **Vysvětlení od ředitele Úřadu** (§ 146 odst. 1) — v případě podezření na nezákonnost, omezování práv nebo vadnost řízení;
2. **Oznámení řediteli Úřadu a předsedovi vlády** (odst. 2) — v případě **prokázaného porušení zákona** zaměstnancem.

#### Výjimka z mlčenlivosti (§ 147)
...
> **Pojetí kapitoly:** Část osmá tvoří **sankční páteř zákona** — komplexní katalog přestupků fyzických osob, podnikatelů, právnických osob, orgánů státu a kontrolovaných osob za nedodržení povinností stanovených ZOUI. Pokuty se pohybují v rozmezí od **30 000 Kč** (drobné formální nedostatky) do **5 000 000 Kč** (závažné porušení ochrany UI nebo nepovolený vývoz kryptografického prostředku). Zvláštními rysy úpravy jsou: **trestnost pokusu** u některých přestupků (§ 148 odst. 2), **trestnost návodce a pomocníka** (§ 148 odst. 3), **opakované přestupky** s vyšší sankcí (§ 155 odst. 3) a **rozdělení projednávací pravomoci** mezi NBÚ a NÚKIB (§ 156). Procesně se postupuje **subsidiárně podle správního řádu** (viz § 159 in fine) a podle zákona č. 250/2016 Sb., o odpovědnosti za přestupky a řízení o nich.

### § 148 — Přestupky fyzické osoby
...
#### Dvanáct skutkových podstat — taxativní výčet

§ 148 obsahuje **12 skutkových podstat** přestupků fyzické osoby — komplexní katalog pokrývající celou škálu povinností, od formálních (oznamovací povinnosti) přes operativní (kryptografická ochrana) po fundamentální (ochrana UI). Klasifikace:

| Skupina | Písm. | Maximální pokuta |
|---|---|---|
| **Formální (oznamovací)** | a) | 50 000 Kč |
| **Drobné věcné** | l) (jednací oblast) | 50 000 Kč |
| **Odevzdání nálezů** | b) | 100 000 Kč |
| **Funkce bezp. ředitele** | e) | 100 000 Kč |
| **Kryptografická obsluha** | f), g), h), k) | 500 000 Kč |
| **Neoprávněný přístup k UI** | i) | 1 000 000 Kč |
| **Porušení mlčenlivosti** | c) | 5 000 000 Kč |
| **Umožnění přístupu neoprávněné osobě** | d) | 5 000 000 Kč |
| **Vývoz kryptografického prostředku** | j) | 5 000 000 Kč |

#### Trestnost pokusu (odst. 2)

**Mimořádné rozšíření odpovědnosti**: pokus přestupku je trestný u tří závažných skutkových podstat:

- **Písm. d)** — umožnění přístupu neoprávněné osobě (5 mil. Kč);
- **Písm. i)** — neoprávněný přístup k UI (1 mil. Kč);
- **Písm. j)** — nepovolený vývoz kryptografického prostředku (5 mil. Kč).

Pokus je definován jako přípravné jednání směřující k naplnění skutkové podstaty, jež se však nepodařilo dovršit. Tato úprava je analogií trestněprávní úpravy pokusu (§ 21 trestního zákoníku).

#### Trestnost návodce a pomocníka (odst. 3)

U přestupků **písm. b) a c)** je trestný také **návodce nebo pomocník**. To se týká:

- **Návodu k nesprávnému jednání** s nalezenou písemností (b);
- **Návodu k porušení mlčenlivosti** o UI (c).

Tato úprava obrací obvyklý princip přestupkového práva (které se zaměřuje na hlavního pachatele) — odráží společenskou závažnost ochrany UI.

#### Vysoké pokuty u nejzávažnějších přestupků
...
#### Specifická odpovědnost držitele osvědčení/oprávnění

§ 149 sankcionuje **fyzickou osobu s přístupem k UI** za porušení specifických povinností správy UI: administrativní evidence, kopírování, předávání, přeprava, změny stupně utajení, IT systémy, kryptografie. Pokuty 500 000 Kč nebo 1 000 000 Kč.

#### Trestnost organizátora, návodce a pomocníka (odst. 2)
...
#### Formální „administrativní" přestupky

§§ 150–152 sankcionují drobné formální povinnosti držitelů jednotlivých typů oprávnění (osvědčení FO, oznámení podle § 6, dokladu o bezpečnostní způsobilosti):

- **Neodevzdání neplatné listiny**;
- **Neoznámení ztráty, odcizení nebo poškození**;
- **Neoznámení změny údajů**.
...
#### Nejrozsáhlejší přestupkový katalog (38 skutkových podstat)

§ 153 je **nejrozsáhlejším** ustanovením přestupkového katalogu ZOUI a obsahuje celkem **38 skutkových podstat** (odst. 1: 26 + odst. 2: 12). Adresáty jsou:

1. **Podnikatel s přístupem k UI**;
2. **Právnická osoba podle § 60b** (typicky státní podnik);
3. **Orgán státu**.

#### Tři skupiny podle sankce

| Skupina | Pokuta | Typ povinnosti |
|---|---|---|
| **Lehčí** | 300 000 Kč | Ostraha Vyhrazené, BPS, ATOMAL, BezpŘ, oznámení BezpŘ, vyznačení UI, klasifikace, evidence |
| **Střední** | 500 000 Kč | Oznámení změny utajení, ostraha zabezpečené oblasti, projekt bezpečnosti, evidence UI |
| **Závažnější** | 1 000 000 Kč | Vyznačení UI původcem, IS bez certifikace, kryptografie bez certifikace, registr |

#### Materiální rozsah

§ 153 odst. 1 a 2 pokrývají v podstatě **celý komplex povinností** podnikatele/PO/orgánu státu při nakládání s UI — od ostrahy fyzických objektů přes vedení evidencí po IT a kryptografickou bezpečnost. Praktická aplikace:
...
#### Specifický přestupek v kontextu zadávání veřejných zakázek
...
#### Specifické přestupky podnikatele s přístupem k UI

§ 154 doplňuje § 153 o **další specifické přestupky** podnikatele:

- **Nepředání UI** při zániku platnosti (písm. a) — 1 mil. Kč;
- **Neaktualizace bezpečnostní dokumentace** (písm. b) — 1 mil. Kč;
- **Nesprávné poskytnutí UI zahraničnímu partneru** (písm. c, d) — až 5 mil. Kč;
- **Nepovolený vývoz krypto-prostředku** (písm. e) — 5 mil. Kč;
- **Neinformování o prohlášeních** (písm. f, g) — 300 tis. Kč.
...
#### Formální administrativní přestupky podnikatele

§ 155 sankcionuje **formální povinnosti držitele osvědčení podnikatele**: odevzdání neplatného osvědčení, oznámení ztrát, oznámení změn údajů. Pokuty jsou **nízké** (50 000–100 000 Kč).

#### Opakovaný přestupek (odst. 3) — zvláštní institut

§ 155 odst. 3 zavádí **specifický institut opakovaného přestupku**:

- Pevný rozsah pokuty: **10 000–70 000 Kč** (s minimem!);
- Definice opakování: nový přestupek do **12 měsíců** od nabytí právní moci rozhodnutí o předchozím přestupku stejného typu.
...
§ 155a sankcionuje PO a podnikající FO za:

- **Umožnění citlivé činnosti** osobě bez dokladu/osvědčení (1 mil. Kč);
- **Neoprávněný přístup k UI Vyhrazené** (500 tis. Kč);
- **Neoprávněný přístup k UI Důvěrné a vyšší** (1 mil. Kč).
...
#### Rozdělení projednávací pravomoci NBÚ a NÚKIB

§ 156 zakotvuje **klíčové pravidlo příslušnosti**: většinu přestupků projednává NBÚ; **NÚKIB** projednává přestupky týkající se:

- Kryptografické ochrany (§ 148 odst. 1 písm. f–h, j, k);
- Informačních a komunikačních systémů (§ 149 odst. 1 písm. g–k);
- Bezpečnostní provozní směrnice, IT systémů, kryptografie u PO/podnikatelů (§ 153 odst. 1 písm. b, s–z);
- Kompromitujícího vyzařování a kryptografie (§ 153 odst. 2 písm. f, j);
- Nepovoleného vývozu krypto-prostředků podnikatelem (§ 154 odst. 1 písm. e).

Toto rozdělení **odpovídá rozdělení působnosti** mezi NBÚ a NÚKIB (§ 137 a § 137a) — NÚKIB sankcionuje to, co spadá do jeho kompetence.
...
> **Pojetí kapitoly:** Část devátá uzavírá zákon **přechodnými** ustanoveními (§ 157, řeší zachování platnosti veřejných listin vydaných za starší úpravy zákonem č. 148/1998 Sb.), **zmocňovacím** ustanovením k vydání prováděcích vyhlášek (§ 158), **odkazem** na subsidiární použitelnost správního řádu (§ 159), **zrušovacím** ustanovením (§ 160) a stanovením **účinnosti** ke dni 1. ledna 2006 (§ 161).
...
1. **Utajovaná skutečnost → utajovaná informace** (odst. 1) — terminologická aktualizace;
2. **Státní a služební tajemství → utajovaná informace** (odst. 1) — zrušení dvojkolejnosti;
3. **Stupeň utajení zachován** (odst. 2);
4. **Osvědčení podle starého zákona → osvědčení podle nového zákona** (odst. 5);
5. **Doklad o bezpečnostní způsobilosti → doklad podle ZOUI** (odst. 6);
6. **Oznámení o Vyhrazené → 6 měsíců přechodný režim** (odst. 7);
7. **Souhlas s jednorázovým přístupem → 6 měsíců** (odst. 8).

#### Klíčové datum: 1. ledna 2008

Odst. 3 stanoví, že **dnem 1. ledna 2008** se ze zákona zrušují stupně utajení u utajovaných písemností vzniklých **do 31. prosince 1992** (tedy z federální éry a před ní), pokud odpovědná osoba do konce r. 2007 nestanovila jinak. Toto ustanovení provádí **historickou redukci** utajení — princip, že informace 15 let staré již zpravidla nemají bezpečnostní hodnotu.

#### Procesní přechod (odst. 18–24)

- **Bezpečnostní prověrka zahájená před účinností** se dokončí podle dosavadních předpisů (odst. 18);
- **Stížnost** se vyřídí podle dosavadních předpisů (odst. 21);
- **Opravný prostředek u Kolegia** se vrátí orgánu (odst. 22) — Kolegium na úseku ochrany utajovaných skutečností (existující podle staré úpravy) bylo zrušeno;
- **Řízení o pokutě** zahájené před účinností se dokončí podle dosavadních předpisů (odst. 24).

#### Technické přechody (odst. 25–27)

- **Komunikační systém** lze provozovat nejdéle 12 měsíců do schválení projektu bezpečnosti (odst. 25);
- **Kryptografické pracoviště** — 12 měsíců do schválení (odst. 26);
- **Stínicí komora MZV** — 24 měsíců do certifikace (odst. 27).

#### Cut-off datum pro nové předpisy (odst. 28)
...
#### Dvojí prováděcí vyhláška

§ 158 svěřuje vydání prováděcích vyhlášek **dvěma orgánům**:

1. **NBÚ** — k provedení 13 specifických ustanovení ZOUI: typy materiálů, lhůty, formuláře, vzory dokladů, manipulace s UI, kurýrní listy aj.;
...
§ 159 vylučuje **plošné použití správního řádu** na bezpečnostní řízení. Subsidiární použití SŘ je **omezeno na tři okruhy**:

1. **Řízení podle § 35 odst. 2** — schvalování bezpečnostního projektu komunikačního systému;
2. **Řízení podle Části druhé Hlavy IX** — typicky řízení o akreditaci a certifikaci podle § 46 a násl.;
3. **Řízení o přestupcích** podle Části osmé.

Mimo tyto tři okruhy se na bezpečnostní řízení (zejm. řízení o vydání osvědčení, dokladu a o zrušení platnosti) **správní řád nepoužije**. Bezpečnostní řízení je tedy v zásadě **autonomním procesním režimem**, vůči němuž je SŘ vyloučen ve smyslu § 1 odst. 2 SŘ („nestanoví-li zvláštní zákon jiný postup").
...
> **§ 160**
>
> *Zrušuje se: [výčet 24 zrušovaných předpisů — zákony č. 164/1999 Sb., 363/2000 Sb., 386/2004 Sb. novelizující zákon č. 148/1998 Sb.; nařízení vlády č. 340/2002 Sb., 385/2003 Sb., 31/2005 Sb., 246/1998 Sb. a 7 jeho novel; vyhlášky č. 137/2003 Sb., 245/1998 Sb., 397/2000 Sb., 263/1998 Sb., 12/1999 Sb., 337/1999 Sb., 56/1999 Sb., 339/1999 Sb., 136/2001 Sb., 348/2002 Sb.].*

**Výklad:**

#### Komplexní zrušení dosavadní úpravy

§ 160 zrušuje **24 právních předpisů** — celý komplex normativní úpravy ochrany utajovaných skutečností před účinností ZOUI. Zrušení se týká:

1. **Tří zákonů** (novelizující 148/1998 Sb.) — sám zákon č. 148/1998 Sb. byl zrušen samostatným ustanovením v rámci širší rekodifikace;
2. **Šest nařízení vlády** — citlivé činnosti, seznam UI a jeho novely;
3. **Patnáct prováděcích vyhlášek** — administrativní, technická, fyzická, IT, kryptografická bezpečnost; bezpečnostní způsobilost.

#### Důsledek: kompletní nahrazení normativního prostředí
...
#### Dlouhá legisvakanční lhůta

Zákon č. 412/2005 Sb. byl vyhlášen ve Sbírce zákonů dne **20. října 2005** s účinností od **1. ledna 2006** — **legisvakanční lhůta přibližně 10 týdnů**. Tato lhůta je vzhledem k složitosti zákona a nutnosti přípravy prováděcích vyhlášek a interních systémů orgánů státu poměrně krátká, ale postačovala díky tomu, že jádro úpravy přebíralo strukturu zákona č. 148/1998 Sb.
...
#### Poznámkový aparát (poznámky pod čarou)

Zákon obsahuje **přibližně 70 poznámek pod čarou** odkazujících na související právní předpisy. Klíčové jsou zejména odkazy na:

- **Zpravodajské služby** — zákon č. 153/1994 Sb. (BIS, ÚZSI), zákon č. 154/1994 Sb. (status BIS), zákon č. 289/2005 Sb. (Vojenské zpravodajství);
- **Policii ČR** — zákon č. 273/2008 Sb.;
- **Trestní řízení** — trestní řád, trestní zákoník;
- **Správní soudnictví** — zákon č. 150/2002 Sb. (SŘS);
- **Veřejné zakázky** — zákon č. 134/2016 Sb.;
- **Mezinárodní organizace** — nařízení o EPPO (2017/1939), Eurojust (2018/1727), Europol (2016/794);
- **Diplomatická úmluva** — Vídeňská úmluva o diplomatických stycích (157/1964 Sb.).

Tento rozsáhlý poznámkový aparát potvrzuje, že **ZOUI je integračním zákonem**, který se v praxi propojuje s řadou dalších předpisů a tvoří **systémovou součást bezpečnostního práva ČR**.

---

## Závěrečná shrnutí kapitoly

Druhá polovina zákona č. 412/2005 Sb. (Části III–IX) představuje **funkční pilíř** celé úpravy ochrany utajovaných informací a bezpečnostní způsobilosti v ČR:

1. **Bezpečnostní způsobilost** (Část III, §§ 80–88) zavádí samostatný, lehčí institut prověřování pro citlivé činnosti, jehož cíl je užší než u osvědčení k UI. Klíčovými jsou: doklad jako veřejná listina s 10letou platností; spolehlivost definovaná negativně; speciální režim pro zpravodajské služby.

2. **Bezpečnostní řízení** (Část IV, §§ 88a–135) tvoří komplexní procesní úpravu autonomní vůči správnímu řádu. Klíčové aspekty: neveřejnost, omezené nahlížení do svazku, povinný pohovor u stupně Přísně tajné, rozkladový mechanismus s rozkladovou komisí, specifický soudní přezkum.

3. **Institucionální rámec** (Část V, §§ 136–142) určuje NBÚ jako ústřední správní úřad, jeho ředitele jmenuje vláda po projednání ve výboru PS. NÚKIB jako vyčleněný úřad přebírá kybernetickou a kryptografickou agendu. Zpravodajské služby a Ministerstvo vnitra mají *quasi*-správní postavení v rámci vlastní personální oblasti.

4. **Kontrolní mechanismy** (Části VI a VII, §§ 143–147) zaručují jak věcnou kontrolu (NBÚ vs. povinné osoby), tak demokratickou kontrolu (kontrolní orgán PS nad NBÚ).

5. **Sankční katalog** (Část VIII, §§ 148–156) — 9 paragrafů, desítky skutkových podstat, pokuty 30 000–5 000 000 Kč; trestnost pokusu, návodce, pomocníka, opakovaný přestupek; rozdělení projednávací pravomoci mezi NBÚ a NÚKIB.

6. **Přechodný a závěrečný rámec** (Část IX, §§ 157–161) zajistil plynulý přechod z úpravy zákona č. 148/1998 Sb., s účinností od 1. ledna 2006.
